...
def main(parser_data):
    ...
    val_dataset = VOCDataSet(parser_data.data_path, "2012", data_transform["val"], "val.txt")
    ...
    # 将验证结果保存至txt文件中
    with open("record_mAP(12.14).txt", "w") as f:
...
if __name__ == "__main__":
    ...
    # 训练好的权重文件
    parser.add_argument('--weights', default='./multi_train/model_19.pth', type=str, help='training weights')
