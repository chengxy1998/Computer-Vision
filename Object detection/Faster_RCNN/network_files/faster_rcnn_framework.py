...
class FasterRCNNBase(nn.Module):
    ...
    def __init__(self, backbone, rpn, roi_heads, transform, phi):
        ...
        if 1 <= self.phi and self.phi <= 3:
            # self.feature_att = attention_block[self.phi - 1](256)
            self.feature_att = attention_block[self.phi - 1](1280)
    ...
    def forward(self, images, targets=None):
        ...
        ###添加注意力机制
        if 1 <= self.phi and self.phi <= 3:
            features=self.feature_att(features)
        ###
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        super(FasterRCNN, self).__init__(backbone, rpn, roi_heads, transform, phi)
